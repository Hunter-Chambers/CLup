...
def makeReservation(customer, startTime, currentTime = datetime.now().strftime("%H%M")):
    ...
    if (startTime == "ASAP"):
        ...
        with open(filePath + day + ".json", "w") as f:
...
if (__name__ == "__main__"):
    ...
    #print('Just before make reservation!')
    makeReservation(json.loads(sys.argv[5]), sys.argv[6])
# end if
