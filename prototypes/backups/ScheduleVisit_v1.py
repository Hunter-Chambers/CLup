            ...
            if choice == 'A':
                ...
                while not room and k < numKeys:
                    ...
                    while valid and ptr - k < blocksToCheck:
                        ...
                        if shoppingCustomers[keys[ptr]]['num_reservations'] + partySize > limit:
                            valid = False
                ...
                if room:
                    ...
                    for j in range(k, k + blocksToCheck):
                        shoppingCustomers[keys[j]]['num_reservations'] += partySize
...
def main():
    ...
    shoppingCustomers = {
            "0000": {'num_reservations': 60},
            "0015": {'num_reservations': 10},
            "0030": {'num_reservations': 10},
            "0045": {'num_reservations': 10}
            }
    limit = 60
